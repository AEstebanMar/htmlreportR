...
htmlreportR provides a new way to build html files from R. It allows the usage of custom css
templates and JavaScript libraries, and comes with integrated CanvasXpress plotting capability.
By default, reports are saved in compressed format.
