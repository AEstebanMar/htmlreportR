...
htmlReport <- setRefClass("htmlReport",
    field = list(hash_vars = "list", all_report = "character", 
                 ...
                 js_files = "character", css_files = "character",
                 js_cdn =  "character", css_cdn =  "character",
                 mermaid = "logical", bs_tables = "character",
                 dt_tables = "character", count_objects = "numeric",
                 custom_buttons = "character", dynamic_js = "character",
                 index_items = "matrix", index_type = "character",
                 features = "list", source_folder = "character",
                 compress = "logical"),
